...
SWIFT_CLASS_NAMED("DeviceLog")
@interface DeviceLogEntity : NSManagedObject
...
@interface DeviceLogEntity (SWIFT_EXTENSION(SesameSDK))
@property (nonatomic, copy) NSString * _Nullable action;
@property (nonatomic, copy) NSString * _Nullable actorId;
@property (nonatomic, copy) NSString * _Nullable actorName;
@property (nonatomic, copy) NSString * _Nullable actorUUID;
@property (nonatomic, strong) NSData * _Nullable bleId;
@property (nonatomic, copy) NSString * _Nullable deviceId;
@property (nonatomic, copy) NSString * _Nullable entryPoint;
@property (nonatomic, strong) NSDate * _Nullable ingestionTime;
@property (nonatomic, copy) NSString * _Nullable location;
@property (nonatomic) BOOL locked;
@property (nonatomic) int64_t msTimestamp;
...
@property (nonatomic, strong) NSData * _Nullable userId;
@end
